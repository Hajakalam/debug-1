...
def process_payment(payment):
    ...
    timeout = int(config['API_TIMEOUT'])  # This is "30" (string) not 30 (int)

    max_retry = int(config['MAX_RETRY'])  # This is "3" (string) not 3 (int)
    ...
    try:
        ...
        return {"status": "error", "reason": f"Processing failed: {e}"}
